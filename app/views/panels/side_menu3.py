...
class SideMenuPanel3(wx.Panel):
        ...
        def __init__(self, parent,*args):
                ...
                nodeLoader = importlib.import_module('controllers.node_load_controller','.')
                ol = nodeLoader.NodeLoader()
                node_list = ol.loadNodes()
                
                for o in node_list:
                    # print(o.name)
                    # png = wx.Image("resourses/"+rs["path"]+rs['sprites'][0], wx.BITMAP_TYPE_ANY).ConvertToBitmap()
                    m_bpButton1 = wx.BitmapButton( m_scrolledWindow4, wx.ID_ANY, wx.Bitmap( u"resourses/UI/026-add.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
                    ...
                    m_staticText1 = wx.StaticText( m_scrolledWindow4, wx.ID_ANY, u""+o.title, wx.DefaultPosition, wx.DefaultSize, 0 )
